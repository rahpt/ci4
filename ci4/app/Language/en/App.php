...
return [
    ...
    "dashboard_chart_auth" => "Social Authentication",
    ...
    "template_subtitle_sms" => "SMS Templates",
    ...
    "template_label_confirmation_sms" => "Phone Confirmation",
    ...
    "notification_grid_sms" => "SMS Sent?",
    ...
    "notification_field_send_sms" => "Send by SMS?",
    ...
    // v1.3.0
    "group_rules_label_activity" => "Activities",
    "group_rules_label_notification" => "Notifications",
    "notification_group_notification" => "Notification",
    "notification_group_notification_view" => "See details",
    "login_mobile" => "Phone",
    "login_mobile_ph" => "Enter your cell phone number",
    "login_rules_mobile_r" => "The phone field is mandatory!",
    "oauth_label_url_return" => "Return URL",
    "menu_modules" => "Modules",
    "module_title" => "Modules",
    "module_subtitle" => "Install Modules",
    "module_alert_success" => "Success!",
    "module_alert_error" => "Error!",
    "group_rules_label_module" => "Install Modules",
    "module_subtitle_install" => "Add New Module",
    "module_subtitle_grid" => "Installed Modules",
    "module_upload_msg" => "Install Module (.zip)",
    "module_name" => "Name",
    "module_version" => "version",
    "module_dir" => "Directory",
    "module_create_date" => "Create Date",
    "module_update_date" => "Update Date",
    "module_status" => "Status",
    "module_uninstall" => "Uninstall",
    "module_uninstall_title" => "Are you sure you want to uninstall?",
    "module_uninstall_subtitle" => "You will not be able to retrieve this information and the data will be removed!",
    "module_uninstall_btn_ok" => "Yes, Uninstall!",
    "module_uninstall_btn_cancel" => "Cancel",
    "module_alert_sql_install" => "Error installing SQL on database.",
    "module_alert_sql_uninstall" => "Error uninstalling SQL on database.",
    "module_alert_sql_update" => "Error updating SQL on database.",
    "module_alert_unzip" => "Error unpacking module.",
    "module_alert_404" => "Module folder not found.",
    "module_alert_file" => "File incompatible with .zip",
    "module_alert_install" => "Module successfully installed!",
    "module_alert_update" => "Module updated successfully!",
    "module_alert_uninstall" => "Module successfully uninstalled!",
    "settings_field_send_pusher_notification_register" => "Pusher Notification",
    "settings_label_notification_subtitle_2" => "Configure below Pusher Notifications settings:",
    "pusher_appId" => "App ID",
    "pusher_key" => "Public Key",
    "pusher_secret" => "Secret Key",
    "pusher_cluster" => "Cluster",
    "pusher_useTLS" => "Enable (TLS)",
    "pusher_scheme" => "Enable (HTTPS)",
    "notification_title_pusher" => "New Notification",
    "module_alert_status" => "Change Status",
    "module_alert_delete" => "Delete",
    "module_alert_incompatible_install" => "The addon is incompatible!",
    "settings_label_customization" => "Customization",
    "settings_label_customization_title" => "Customization",
    "settings_label_customization_subtitle_1" => "Set below if you want to enable the use of Modules and Layouts:",
    "settings_field_enable_module" => "Use of Modules",
    "settings_field_enable_layout" => "Use of Templates",
    "module_alert_permission" => "Permission Group",
    "module_permission" => "Permission",
    "module_permission_model" => "Permission Group Assignment",
    "module_permission_available" => "Available Groups",
    "module_permission_assigned" => "Assigned Groups",
    "module_permission_search" => "Search...",
    "module_permission_save" => "Save",
    "module_permission_cancel" => "Cancel",
    "module_attributed_title_success" => "Saved successfully!",
    "module_attributed_title_error" => "An error has occurred!",
    "module_attributed_success" => "Permissions successfully assigned!",
    "module_attributed_error" => "Error assigning permission!",
    "settings_label_api_rules" => "API Permissions",
    "settings_field_send_mail" => "* Please save the settings before testing sending email.",
    "profile_subtitle_delete" => "Delete my data",
    "profile_delete_data" => "Delete All",
    "profile_download_data" => "Download Data",
