    ...
    <div class="container-fluid h-100">
        <div class="row justify-content-center h-100 align-items-center">
            <div class="col-md-4">
                            ...
                            <div class="auth-form">
                                ...
                                <form action="<?= url_to('login') ?>" method="post">
                                    ...
                                    <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                        <div class="form-group">
                                            <?php if (setting('App.remember_me') ?? false): ?>
                                        ...
                                        <div class="form-group">
                                            <?php if (setting('App.forgot_password') ?? false): ?>
                                    ...
                                    <?php if (setting('App.captcha_login') ?? false): ?>
                                        <?php if (setting('App.captcha_gateway') == 'recaptcha'): ?>
                                            <div class="text-center mt-2">
                                                <div class="g-recaptcha" style="display: inline-block" data-sitekey="<?= setting('App.captcha_site_key') ?? '' ?>"></div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if (setting('App.captcha_gateway') == 'hcaptcha'): ?>
                                            <div class="text-center mt-2">
                                                <div class="h-captcha" style="display: inline-block" data-sitekey="<?= setting('App.captcha_site_key') ?? '' ?>"></div>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </form>
                ...
                <?php if (setting('App.registration') ?? false): ?>
